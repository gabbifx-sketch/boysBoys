...
const games = [
  ...
  },
  {
    ...
    categories: ["Action", "Sports", "Simulation"],
  ...
  },
  {
    ...
    id:  "Buggy Racing",
    categories: ["Action", "Driving", "Arcade"],
          platform: {
          mobile: false,
          desktop: false
    }
    ...
    categories: ["Driving", "Simulation", "Action"],
...
games.forEach(game => {
  ...
  card.innerHTML = `
       <a href="./playGames.html?game=${encodeURIComponent(game.id)}">
